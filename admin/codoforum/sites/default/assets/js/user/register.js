    ...
    jQuery('document').ready(function($) {
        ...
        $('#reg_username').blur(function() {
            ...
            if (username.length && username.length < codo_defs.register.username_min) {
                ...
                that.next().html(CODOF.pass.trans.username_short).slideDown();
            } else
            {
                ...
                $.getJSON(codo_defs.url + "Ajax/user/register/username_exists",
                    ...
                    if (response.exists) {
                        register.errors.name = true;
                        that.next().html(CODOF.pass.trans.username_exists).slideDown();
                    } else {
        ...
        $('#reg_mail').blur(function() {
            ...
            $.getJSON(codo_defs.url + "Ajax/user/register/mail_exists",
                ...
                if (response.exists) {
                    ...
                    that.next().html(CODOF.pass.trans.mail_exists).slideDown();
                } else {
        ...
        $('#password').blur(function() {
            ...
            if (pass.length && pass.length < len) {
                ...
                $(this).next().html(CODOF.pass.trans.password_short).slideDown();
            } else {
                $(this).next().slideUp();
            }
        });
