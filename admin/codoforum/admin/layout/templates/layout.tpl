      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li  class="{$active.users}"><a href="index.php?page=users"><i class="fa fa-bar-chart-o"></i> Users</a></li>
            ...
            <li  class="{$active.sso}"><a href="index.php?page=sso"><i class="fa fa-file"></i> SSO Settings</a></li>
            <li  class="{$active.importer}"><a href="index.php?page=importer"><i class="fa fa-file"></i> Importer</a></li>
