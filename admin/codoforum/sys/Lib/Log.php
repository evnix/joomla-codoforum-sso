...
class Log {
    ...
    public static function insert($options) {
        ...
        $qry = 'INSERT INTO codo_logs (uid,log_type,message,severity,location,log_time) '
                . 'VALUES(:uid,:log_type,:message,:severity,:location,:log_time)';
        $stmt = $db->prepare($qry);
    ...
    public static function set_options($options, $message) {
        ...
        if (!isset($options['location'])) {
            ...
            $options['location'] = self::get_location();
        }
    ...
    public static function get_location() {
        ...
        $caller = end($trace);
        return "Called by " . $caller['function'] . " in " . $caller['file'];
    }
