...
class Kunena3 {
    ...
    public function get_topics($start) {
        ...
        $qry = "SELECT t.id AS tid, t.subject AS title,t.category_id AS cat_id,t.first_post_time AS topic_created,
                t.last_post_time AS topic_updated,t.first_post_userid AS uid, t.first_post_id AS post_id
    ...
    public function get_users($start) {
        ...
        $qry = "SELECT u.id AS id, u.username AS username, u.name AS name, u.password AS pass,
                 ...
                 CASE WHEN u.block=1 THEN 0 ELSE 1 END AS status
